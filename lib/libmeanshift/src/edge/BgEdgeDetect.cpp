...
float BgEdgeDetect::VerticalLineEval(float x, float )
{
   return (x-rankTr_);
}

float BgEdgeDetect::VerticalLineComp(float x0, float , float x, float )
{
...
float BgEdgeDetect::HorizontalLineEval(float , float y)
{
   return(y-confTr_);
}

float BgEdgeDetect::HorizontalLineComp(float , float y0, float , float y)
{
...
float BgEdgeDetect::CustomRegionComp(float , float , float , float )
{
   return 0;
}
